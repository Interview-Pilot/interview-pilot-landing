...
const scoreMetrics = [
  ...
  { label: 'Specificity', score: 61, color: '#ffd01e' },
                    ...
                    >
                      ...
                      <Box position="relative">
                        ...
                        <Box
                          ...
                          boxShadow="0 0 40px rgba(255, 208, 30, 0.12)"
                        >
                          <Text
                    ...
                    {transcript.map((item, i) => (
                      <Box key={i}>
                        ...
                        <Box
                          p={3}
                          borderRadius="10px"
                          bg={item.isActive ? 'rgba(255,208,30,0.07)' : 'rgba(255,255,255,0.04)'}
                          border="1px solid"
                          borderColor={item.isActive ? 'rgba(255,208,30,0.3)' : 'rgba(255,255,255,0.07)'}
                        >
                          <Text
                            fontSize="sm"
              ...
              >
                ...
                >
                  ...
                  <Box
                    ...
                    border="1px solid"
                    borderColor="rgba(255,208,30,0.15)"
                  >
                  ...
                  <VStack align="stretch" spacing={2}>
                    {[
                      ...
                      <HStack
                        ...
                        py={2.5}
                        borderRadius="9px"
                        bg={role.active ? 'rgba(255,208,30,0.1)' : 'rgba(255,255,255,0.04)'}
                        border="1px solid"
                        borderColor={role.active ? 'rgba(255,208,30,0.35)' : 'rgba(255,255,255,0.07)'}
                        justify="space-between"
                        cursor="pointer"
                      >
